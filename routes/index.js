...
router.get('/', function (req, res) {
 res.render('index', { title: 'kangaroo App', user : req.user });
});
router.get('/register', function(req, res) {
 res.render('register', { title: 'kangaroo App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'kangaroo App Login', user : req.user });
 });
